...
(function(){
  ...
  function animateRing(){
    ...
    const target=60,circumference=327,targetDash=(target/100)*circumference;
  ...
  if(document.readyState==='complete'||document.readyState==='interactive')setTimeout(animateRing,50);
})();
